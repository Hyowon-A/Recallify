...
public class FlashcardService {
    ...
    @Autowired
    public FlashcardService(FlashcardRepository flashcardRepository, SetRepository setRepository, GeminiService geminiService, PdfUploadService pdfUploadService, FlashcardParser flashcardParser) {
